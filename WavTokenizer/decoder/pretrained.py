...
def instantiate_class(args: Union[Any, Tuple[Any, ...]], init: Dict[str, Any]) -> Any:
    ...
    '''shwj
        # class_module = class_module.removeprefix("decoder")失败
        # print(sys.path)
        # sys.path.append("../")

        试图导入 from decoder.feature_extractors import EncodecFeatures


        class_module, class_name
        'decoder.feature_extractors'  'EncodecFeatures'
        想实现相对导入
...
'''
    ...
    class_module = f"WavTokenizer.{class_module}"

    module = __import__(class_module, fromlist=[class_name], level=0)

    ...
    def __init__(self, feat_dim=80, channels=512, emb_dim=192, global_context_att=False,
        ...
        if feat_type == 'fbank':
            ...
            if config_path is None:
                # self.feature_extract = torch.hub.load('/aifs4su/data/zheny/s3prl-s3prl-42086bd',feat_type,path='/root/.cache/s3prl/download/wavlm_large.pt', source='local')
                # self.feature_extract = torch.load('/data/zheny/ns2_ct2_mel/wavlm_large_finetune.pth') #torch.hub.load_state_dict_from_url('/root/.cache/torch/hub/s3prl-s3prl-42086bd',feat_type, source='local')
